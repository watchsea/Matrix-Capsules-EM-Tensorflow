...
#   environment setting    #
############################
flags.DEFINE_string('dataset', 'E:/study/dl/train_data/*.0000.15m.csv', 'the path for train dataset')   #data/mnist
flags.DEFINE_string('test_dataset', 'E:/study/dl/test_data/rb.HOT.60m(1).csv', 'the path for test dataset,must be only one')   #data/mnist
