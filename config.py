...
flags.DEFINE_float('ac_lambda_step', 0.01, 'It is described that \lambda increases at each iteration with a fixed schedule, however specific super parameters is absent.')
...
#   environment setting    #
############################
flags.DEFINE_string('dataset', 'E:/study/dl/train_data/*.tfrecord', 'the path for train dataset')   #*.0000.*.csv
...
flags.DEFINE_boolean('is_feature_store', True, 'ouput the true label data')
